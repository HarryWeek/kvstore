...
void large_value_get_testcase_1w(int connfd,int count) {
    ...
    for (int i = 0; i < count; i++) {
        ...
        testcase(connfd, cmd, 2, value, "LGET-BigValue");
    }
    ...
    printf("large_value_get %d --> time_used: %d ms, qps: %d\n",
        count, time_used, qps);
}
//test_large_get 192.168.10.15 2000
int main(int argc, char *argv[]) {
    ...
    large_value_get_testcase_1w(connfd,count);
