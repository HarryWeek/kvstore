...
void array_testcase_1w(int connfd,int count) {
   // int count = 10000;
    printf("array test\n");
...
void array_get_testcase_1w(int connfd,int count) {
    //int count = 10000;
    printf("array test\n");
    struct timeval tv_begin, tv_end;
    gettimeofday(&tv_begin, NULL);
...
//test_array_get 192.168.10.15 2000
int main(int argc, char *argv[]) {
    ...
    array_get_testcase_1w(connfd,count);
